...
import DataStructureAndAlgorithms.core.models.*;
import DataStructureAndAlgorithms.infrastructure.discovery.ClassDiscoveryService_OLD;

public class ProblemPracticeService_OLD {

    private final ClassDiscoveryService_OLD discoveryService;

    private List<ProblemInfo> problemInfoList = new ArrayList<>();
    private List<PracticeInfo> practiceInfoList = new ArrayList<>();

    public ProblemPracticeService_OLD(ClassDiscoveryService_OLD discoveryService) {
